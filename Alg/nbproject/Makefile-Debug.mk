...
${OBJECTDIR}/Alg.o: Alg.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Alg.o Alg.c

${OBJECTDIR}/AlgFunctions/GrahamScan.o: AlgFunctions/GrahamScan.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/GrahamScan.o AlgFunctions/GrahamScan.c

${OBJECTDIR}/AlgFunctions/Exterior.o: AlgFunctions/Exterior.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/Exterior.o AlgFunctions/Exterior.c

${OBJECTDIR}/DataFunctions/group.o: DataFunctions/group.c 
	${MKDIR} -p ${OBJECTDIR}/DataFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataFunctions/group.o DataFunctions/group.c

${OBJECTDIR}/DataFunctions/util.o: DataFunctions/util.c 
	${MKDIR} -p ${OBJECTDIR}/DataFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataFunctions/util.o DataFunctions/util.c

${OBJECTDIR}/DataFunctions/file.o: DataFunctions/file.c 
	${MKDIR} -p ${OBJECTDIR}/DataFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataFunctions/file.o DataFunctions/file.c

${OBJECTDIR}/DataFunctions/point.o: DataFunctions/point.c 
	${MKDIR} -p ${OBJECTDIR}/DataFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataFunctions/point.o DataFunctions/point.c

${OBJECTDIR}/AlgFunctions/Statistically.o: AlgFunctions/Statistically.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/Statistically.o AlgFunctions/Statistically.c

${OBJECTDIR}/AlgFunctions/GaussArea.o: AlgFunctions/GaussArea.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/GaussArea.o AlgFunctions/GaussArea.c

${OBJECTDIR}/AlgFunctions/Concave.o: AlgFunctions/Concave.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/Concave.o AlgFunctions/Concave.c

${OBJECTDIR}/AlgFunctions/Voronoi.o: AlgFunctions/Voronoi.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/Voronoi.o AlgFunctions/Voronoi.c

${OBJECTDIR}/AlgFunctions/JarvisMarch.o: AlgFunctions/JarvisMarch.c 
	${MKDIR} -p ${OBJECTDIR}/AlgFunctions
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/AlgFunctions/JarvisMarch.o AlgFunctions/JarvisMarch.c
